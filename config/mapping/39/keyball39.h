...
// every layer). All 6 Miryoku thumb slots are used: left K32/K33/K34 and right
// K35/K36/K37 on position 38. (Thumb layer routing is set in the base override
// in keyball39_custom_config.h; FUN sits on the inner-left thumb, K34.)
